...
{
    public partial class Registros_Notas : Form
    {
         // singleton
        private static Registros_Notas instancia = null;
        public static Registros_Notas Instancia
        {
            get
            {
                if ((instancia == null) || (instancia.IsDisposed))
                {
                    instancia = new Registros_Notas();
                }
                return instancia;
            }
        }
